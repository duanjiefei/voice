package com.github.duanjiefei.lib_audio.model;
...
import com.github.duanjiefei.lib_audio.mediaplayer.db.AudioBeanDao;
...
public class Favourite {
    ...
    @Generated(hash = 476817479)
    public Favourite(Long id, @NotNull String audioId) {
        this.id = id;
