...
public class BottomMusicView extends RelativeLayout {
  ...
  private void initView() {
    ...
    rootView.setOnClickListener(new OnClickListener() {
      @Override public void onClick(View v) {
        //跳到音乐播放Activitity
        Log.d(TAG,"initView  MusicPlayerActivity.start");
  ...
  private void showLoadView() {
    ...
    if (mAudioBean != null) {
      ...
      mPlayView.setImageResource(R.drawable.note_btn_pause_white);
    }
  }

  private void showPauseView() {
    if (mAudioBean != null) {
      mPlayView.setImageResource(R.drawable.note_btn_play_white);
    }
  }
